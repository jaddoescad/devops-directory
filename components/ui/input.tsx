  ...
  ({ className, hasIcon, children, ...props }, ref) => {
    return (
      <div className="mt-2 flex w-full rounded-md ">
        <div
          className={cn(
            "relative w-full before:pointer-events-none before:absolute before:-inset-1 before:rounded-[9991px] before:border before:border-accent/20 before:opacity-0 before:ring-2 before:ring-neutral-100/40 before:transition",
            ...
            "focus-within:before:opacity-100 focus-within:after:shadow-neutral-100/20"
          )}
        >
          <input
            type="search"
            ...
            className={cn(
              ...
              "relative border border-black/5 bg-white/90 py-4 pl-12 pr-7 placeholder:text-stone-400 focus:bg-white",
              "text-stone-800",
              className
            )}
            ref={ref}
